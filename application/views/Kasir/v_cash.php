            ...
            <div class="col-8 col-md-offset-2">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <h5 class="card-title" style="color: black;"><i class="fa fa-angle-left"></i> Cash</h5>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="col col-sm-11 mb-4 image-menu">
                    <div class="card-text mb-1">Money Received
                    </div>
                    <div class="row">
                        <div class="col-sm-10  mb-2">
                            <h5 class="card-title">60000 </h5>
                        </div>
                    </div>
                </div>
                <div class="col col-sm-11 mb-4 image-menu">
                    <div class="card-text mb-1">Change Money
                    </div>
                    <div class="row">
                        <div class="col-sm-10  mb-2">
