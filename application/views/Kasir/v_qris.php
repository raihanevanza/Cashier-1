            ...
            <div class="col-8 col-md-offset-2">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <h5 class="card-title" style="color: black;"><i class="fa fa-angle-left"></i> QRIS</h5>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="col col-sm-11 mb-4 image-menu">
                    <div class="card-text mb-1 text-center">
                        <h5 class="card-title">Kopi Kenangan Pakansari</h5>
                        <h5 class="card-title">
                            QRIS x Haio. </h5>
                    </div>
                    <div class="row">
                        <div class="col-sm-10 mb-4 ml-5 d-flex justify-content-center">
                            <img src="<?php echo base_url('asset/image/content/qrcode.png') ?>" style="width: 70%;">
                        </div>
                    </div>
                </div>
